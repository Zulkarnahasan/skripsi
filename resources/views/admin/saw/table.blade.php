...
<table class="table mt-3"><thead><tr><th>Rank</th><th>Pendaftar</th><th>Nilai Akhir</th><th>Status</th><th>Diumumkan</th>@if($canEditStatus)<th class="text-end">Ubah Status</th>@endif</tr></thead><tbody>
...
<tr>
    ...
    <td>{{ $result->announced_at?->format('d/m/Y H:i') ?? '-' }}</td>
    @if($canEditStatus)
        <td class="text-end">
